...
//
fun includeProject(name: String, filter: Array<BuildType> = emptyArray(), filePath: String? = null) {
    val file: File

    if (filePath != null) {
        if ((":" + filePath.replace("/", ":")) == name) {
            throw IllegalArgumentException("Redundant filepath for $name, please remove it")
        }

        file = File(rootDir, filePath)
    } else {
        file = File(rootDir, name.substring(1).replace(":", "/"))
    }
...
//    filePath = "annotation/annotation-experimental-lint/integration-tests"
//)
...
//includeProject(":compose:integration-tests:hero:jetsnack:jetsnack-macrobenchmark-target", [BuildType.COMPOSE])
//includeProject(":compose:integration-tests:hero:jetsnack:jetsnack-macrobenchmark", [BuildType.COMPOSE])
//includeProject(":compose:integration-tests:hero:jetsnack:jetsnack-microbenchmark", [BuildType.COMPOSE])
...
includeProject(":paging:paging-common", arrayOf(BuildType.MAIN, BuildType.COMPOSE, BuildType.INFRAROGUE, BuildType.KMP))
includeProject(":paging:paging-common-ktx", arrayOf(BuildType.MAIN, BuildType.COMPOSE))
includeProject(":paging:paging-compose", arrayOf(BuildType.COMPOSE))
...
//includeProject(":paging:paging-runtime", arrayOf(BuildType.MAIN, BuildType.COMPOSE))
//includeProject(":paging:paging-runtime-ktx", arrayOf(BuildType.MAIN))
...
//includeProject(":wear:protolayout:protolayout-testing", [BuildType.MAIN, BuildType.WEAR])
...
//includeProject(":wear:compose:compose-material3-macrobenchmark", "wear/compose/compose-material3/macrobenchmark", [BuildType.COMPOSE])
//includeProject(":wear:compose:compose-material3-macrobenchmark-common", "wear/compose/compose-material3/macrobenchmark-common", [BuildType.COMPOSE])
//includeProject(":wear:compose:compose-material3-macrobenchmark-target", "wear/compose/compose-material3/macrobenchmark-target", [BuildType.COMPOSE])
